/// <summary>
/// API Request to create the customer on ePay
/// </summary>
/// <param name="json">JSON String</param>
/// <param name="URL">URL of the ePay site</param>
/// <param name="epayTokenList">ePay token object</param>
/// <param name="responses">Response object on what is returned from epay</param>
public void CreateCustomer(string json, string URL, EPayToken epayTokenList, ref CreateResponse responses)
{
	...
	var client = new RestClient(CheckURL(URL) + "API/customer");
