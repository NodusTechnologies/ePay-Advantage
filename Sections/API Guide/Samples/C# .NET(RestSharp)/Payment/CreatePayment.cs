/// <summary>
/// API Request to create the payment on ePay
/// </summary>
...
public void CreatePayment(string json, string URL, EPayToken epayTokenList, ref CreateResponse responses)
{
	...
	var client = new RestClient(CheckURL(URL) + "API/payment");
