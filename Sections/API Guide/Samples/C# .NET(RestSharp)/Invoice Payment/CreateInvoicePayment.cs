/// <summary>
/// API Request to create the record for the payment applied to an invoice on ePay
/// </summary>
...
public void CreateInvoicePayment(string json, string URL, EPayToken epayTokenList, ref CreateResponse responses)
{
	...
	var client = new RestClient(CheckURL(URL) + "API/invoicepayment");
