/// <summary>
/// API Request to create the currency on ePay
/// </summary>
...
public void CreateCurrency(string json, string URL, EPayToken epayTokenList, ref CreateResponse responses)
{
	...
	var client = new RestClient(CheckURL(URL) + "API/currency");
