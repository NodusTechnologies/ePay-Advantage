/// <summary>
/// API Request to create the invoice on epay
/// </summary>
/// <param name="json">JSON String</param>
/// <param name="URL">URL on the ePay site</param>
/// <param name="epayTokenList">ePay token object</param>
/// <param name="responses">Returned response object</param>
public void CreateInvoice(string json, string URL, EPayToken epayTokenList, ref CreateResponse responses)
{
	...
	var client = new RestClient(CheckURL(URL) + "API/invoice");
